...
**Tests**: Unit tests are MANDATORY per Constitution Principle III. Integration and contract tests are OPTIONAL - only include them if explicitly requested in the feature specification or required by the feature's scope.
...
**Contract/Integration Tests (OPTIONAL - only if feature requires):**
- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py

**Unit Tests (MANDATORY per Constitution Principle III):**
- [ ] T012 [P] [US1] Unit test for [Entity1] model in tests/unit/test_[entity1].py
...
**Unit Tests (MANDATORY per Constitution Principle III):**
- [ ] T022 [P] [US2] Unit test for [Entity] model in tests/unit/test_[entity].py
- [ ] T023 [P] [US2] Unit test for [Service] in tests/unit/test_[service].py
...
**Unit Tests (MANDATORY per Constitution Principle III):**
- [ ] T030 [P] [US3] Unit test for [Entity] model in tests/unit/test_[entity].py
- [ ] T031 [P] [US3] Unit test for [Service] in tests/unit/test_[service].py
...
- [ ] TXXX Verify unit test coverage meets 80% minimum (Constitution Principle III)
- [ ] TXXX Security hardening and scan remediation (Constitution Principle IV)
...
- Integration/contract tests are optional unless feature specifically requires them
